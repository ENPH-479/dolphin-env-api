...
#include "../../GUI/MemWatcher/DlgChangeType.h"
...
const QMetaObject DlgChangeType::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DlgChangeType.data,
      qt_meta_data_DlgChangeType,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
